    ...
    <div className="flex h-full min-h-0 w-full flex-col bg-[#fafbfc] text-[#0b1f33] print:bg-white">
      ...
      <nav className="min-h-0 flex-1 space-y-0.5 overflow-y-auto px-2.5 py-3 [scrollbar-width:thin]">
        ...
        >
          ...
          {unread > 0 ? (
            <span className="inline-flex h-5 min-w-5 shrink-0 items-center justify-center rounded-full bg-[#dc2626] px-1 text-[0.65rem] font-bold leading-none text-white shadow-sm">
              {unread > 99 ? "99+" : unread}
            </span>
          ) : null}
        </Link>
